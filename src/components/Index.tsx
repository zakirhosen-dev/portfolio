...
export default function Index() {
  const [countGb, setCountGb] = useState("8Gb infinite memory");
    ...
    <div>
      ...
      >
        ...
        <section className="text-area">
          <h2>Customize your mac pro</h2>
          <p>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius
            libero, eos odio impedit, veritatis sapiente voluptatibus nulla
            necessitatibus ipsa nemo nostrum similique voluptate repellat!
          </p>
          <hr />
          <span>
            <h4>memory</h4>
            <button type="button" className=" 8gb btn btn-primary m-2">
              {" "}
              {countGb}
            </button>
            <button type="button" className=" 16gb btn btn-secondary m-2">
              16Gb infinite memory
            </button>
          </span>
          <span className="p-4">
            <h4>Storage</h4>
          ...
          <span>
            ...
            <div className="d-flex flex-row">
              <button type="button" className="btn btn-dark m-2">
                Friday 7 April Free Dlivery
              </button>
              <button type="button" className="btn btn-primary m-2">
                Friday 14 April Free Dlivery
              </button>
            </div>
          </span>
          <span className="calculation-area m-5">
            <ul className="d-flex">
              <h6>Best Price</h6>
              <h6 style={{ marginLeft: "154px", font: "bold" }}>{price}</h6>
            </ul>
            <hr />
            <ul className="d-flex">
              <h6>Extra Memory cost</h6>
              <h6 style={{ marginLeft: "91px", font: "bold" }}>$0</h6>
            </ul>
            <hr />
            <ul className="d-flex">
              <h6>Extra Storage cost</h6>
              <h6 style={{ marginLeft: "100px", font: "bold" }}>$0</h6>
            </ul>
            <hr />
            <ul className="d-flex" style={{ borderBottom: "5px solid black" }}>
              <h6>Dlivery Charge</h6>
              <h6 style={{ marginLeft: "124px", font: "bold" }}>$0</h6>
            </ul>
          </span>
          <span>
            <p> Add promo code</p>
            <div className="d-flex mb-5">
              {" "}
              <input type="number" />
              <button className="btn btn-danger ml-2 ">Apply</button>
            </div>
          </span>
        </section>
      </header>

      <h1 style={{ textAlign: "center" }}> Total $1200</h1>
    </div>
  );
}
